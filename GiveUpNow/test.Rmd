...
set.seed(20021119)
train.forest <- randomForest(shares~timedelta + n_tokens_title + n_tokens_content + num_hrefs + 
    ...
    punc_count + title_subjectivity + title_sentiment_polarity + isHoliday, data = sample.df, importance = TRUE, ntree=50)
train.forest
```
